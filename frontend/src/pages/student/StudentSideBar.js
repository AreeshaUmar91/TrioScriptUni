    ...
    <>
      <React.Fragment>
        ...
        <ListItemButton
          component={Link}
          to="/Student/subjects"
          sx={location.pathname.startsWith('/Student/subjects') ? activeStyle : {}}
        >
          <ListItemIcon>
            <AssignmentIcon />
          </ListItemIcon>
        ...
        <ListItemButton
          ...
          sx={location.pathname.startsWith('/Student/attendance') ? activeStyle : {}}
        >
          <ListItemIcon>
            <ClassOutlinedIcon />
          </ListItemIcon>
        ...
        <ListItemButton
          component={Link}
          to="/Student/complain"
          sx={location.pathname.startsWith('/Student/complain') ? activeStyle : {}}
        >
          <ListItemIcon>
      ...
      <React.Fragment>
        ...
        <ListItemButton
          component={Link}
          to="/Student/profile"
          sx={location.pathname.startsWith('/Student/profile') ? activeStyle : {}}
        >
          <ListItemIcon>
